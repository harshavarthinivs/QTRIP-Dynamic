...
async function fetchReservations() {
  ...
  try
  {
  let fetch_res= await fetch(config.backendEndpoint+"/reservations/");
  let response=await fetch_res.json();
  // console.log("fetch",fetch_res);
  return response;
  }
  catch(err)
  {
...
function addReservationToTable(reservations) {
 ...
 for(let x of reservations)
 {
  ...
  let trow = document.createElement("tr");
    ...
    console.log(config.backendEndpointTemp);
